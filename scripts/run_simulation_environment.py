...
from planners.rrt_star_planner_simple import RRTStarPlanner
...
def main():
    ...
    for i in range(num_steps):
        ...
        sleep_time = (1.0 / env.CTRL_FREQ) - (time.time() - start_time)
        if sleep_time > 0:
